...
if __name__ == "__main__":
    ...
    parser.add_argument('--gold', default='./sparc/dev_gold.txt', dest='gold', type=str)
    parser.add_argument('--pred', default='./predicted_sql.txt',dest='pred', type=str)
    parser.add_argument('--db', default='./sparc/database', dest='db', type=str)
    parser.add_argument('--table', default='./sparc/tables.json', dest='table', type=str)
    parser.add_argument('--etype', default='match', dest='etype', type=str)
    ...
    assert etype in ["all", "exec", "match"], "Unknåown evaluation method"
